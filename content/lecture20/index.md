...
החסם שקיבלנו מאפשר לנו לבחור את גודל המדגם $N$ המבטיח שגיאה קטנה כרצוננו, ובהתסברות גבוה כרצוננו, אם $N>\frac{1}{\varepsilon} \log\frac{|H|}{\delta}$, נקבל כי $L(\hat{h}_{\mathcal{D}})$ בהסתברות $(1-\delta$) לפחות. 
...
$$
P(|L(h)-\hat{L}_{\mathcal{D}}(h)|) > \frac{\varepsilon}{2}) \le 2 |H| \exp \biggl(-N \frac{\varepsilon^2}{2}  \biggr)
$$

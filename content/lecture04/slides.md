...
5. התאמת יתר נמנעת ע"י תהליך הגיזום

#### חסרונות 

1. חלוקה מקבילה לצירים מוגבלת ומתעלמת מקשרים בין משתנים
2. רגישות גבוה לשינויים בנתונים (מופחתת עקב גיזום)
3. דרושים מספר רב של נתונים לקבלת תוצאות סבירות

#### הרחבות 
1. העשרת מבנה החלטות בצמתים (למשל, מסווג לינארי)
2. שיטות אנסמבל - נדון בהמשך

...
ניתן לנסות ולעצור את האלגוריתם לפני שהוא מתכנס למינימום על מנת לנסות והקטין את תופעת ה overfitting. ניתן לעשות זאת על ידי שימוש ב validation set ולבדוק מתי הביצועים על ה validation מתחילים להיפגע. שיטה זו מכונה עצירה מוקדמת (early stopping).

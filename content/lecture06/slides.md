...
- בזמן החזיוי נרצה לבצע את החישוב על פלטפורמה יחסית ולקבל תוצאות מאד מהירות.
...
על פי השיטה שראינו בשבוע שעבר הסבירות לפריקה בהינתן הכל הסימטומים היא חצי.

<br/>

זאת משום שאין אף דגימה בה יש את כל הסימפטומים ןלכן גם הסבירות של פריקה וגם הסבירות של אי-פריקה היא 0.

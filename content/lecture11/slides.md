...
- ב MLP ניתן להגדיל את היכולת הייצוג על ידי הגדלת הרשת (מספר השכבות והרוחב שלהם).
...
- הסיבה שבגללה CNNs מתאימים לפתרון של בעיה זו היא בין היתר בגלל ששתי התכונות, שמבדילות שכבת קנבולוציה משכבות FC, מתאימות לייצוג של הפתרון.

...
# הרצאה 11 - Bagging and Boostiבחר
<div dir="ltr">
...
תגרום כנראה להקטנת ה misclassification rate ובכך להקטנה ה bias. יתרה מזאת, אנו נראה בהמשך כי תחת תנאים מסויימים מתקיים שכאשר $M\rightarrow\infty$ החסם ילך ל-0 וכך גם ה misclassification rate.
...
נציג כאן יש את הפתרון של בעיה זו, כאשר הפיתוח המלא של הפתרון מופיע בסוף ההרצאה. בכדי לרשום את הפתרון בצורה פשוטה נגדיר את הגדלים הבאים ונסביר מה הם מייצגים:
...
זאת אומרת, שקיים חסם לשגיאת ה miscalssification rate אשר דואך באופן מעריכי עם $M$.

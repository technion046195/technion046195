...
- בחירת הארכיטקטורה היא קריטית להביצעים.
- לשימושים שונים מתאימות ארכיטקטורות שונות.
- חלק גדול מאד מהמחקר שנעשה כהיום הוא סביב הנושא של חיפוש ארכיטקטורות.
...
- שהמוצא של הרשת יתנקז לנוירון בודד אם פונקציית הפעלה שמוציאה ערכים בתחום $[0,1]$ כדוגמאת הפונקציה הלוגיסטית.

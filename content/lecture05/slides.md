...
- **בבעיות חזיוי** אנו מועניינים לחזות את ערכו של **משתנה אקראי**, לרוב על סמך משתנה / וקטור אקראי בודד (**דגימה יחידה**).
...
ברצונינו לשערך את ההסתברות של המאורע שנסיעה מסויימת תיקח יותר משעה, $A=\{x<60\}$.
...
- הכלל הנפוץ ביותר הינו לבחור את $k$ להיות שורש מספר הדגימות במדגם (מעוגל כלפי מעלה): $\left\lceil\sqrt{N}\right\rceil$

...
- ניתן לייצר מספר מדגמים על ידי חלוקת המדגם הקיים, אך לרוב העובדה שהמדגמים הם משמעותית קטנים מהמדגם המקורי **תגדיל** את ה variance.
...
- ננסה להשתמש במכלול של חזאים בעלי **bias גבוה** אך **variance נמוך** בכדי ליצור חזאי כולל בעל bias נמוך.
...
בהינתן אוסף של חזאים "חלשים" $\tilde{h}(\boldsymbol{x})$ בעלי bias גבוה, שיטה זו מנסה לבנות חזאי מהצורה של:
...
ונשתמש באי השיוון הנ"ל על כל איבר בסכום בנוסחא ל misclassifiaction rate ונקבל כי:
...
- כמות ה overfitting גדלה בקצב מאד איטי (אם בכלל).
...
ראינו קודם כי שגיאת ה misclassification rate (הלא ממושקלת) של החזאי על המדגם חסומה על ידי הביטוי:

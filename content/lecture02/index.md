...
- **Observations \ measurements** (תצפיות או מדידיות): $\text{x}$ (או במקרה הוקטורי $\mathbf{x}$) - יהיה הוקטור האקראי אשר מכיל את המשתנים שלפיהם נרצה לבצע את החיזוי. במקרים מסויימים החיזוי יהיה על פי משתנה יחיד ואז $\text{x}$ יהיה סקלר.

...
Editable PowerPoint exports can be generated from the Reveal-style slide decks using the standalone converter documented in [docs/editable-pptx-generator.md](docs/editable-pptx-generator.md).
